define("xg/eid-company/1.0.4/p/adminAccount/dataCountDetail/listTmp-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    ...
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        function program6(depth0, data) {
            ...
            buffer += escapeExpression(stack1) + '</td>\r\n            <td><a href="/company/count/everydaydetail.htm?companyId=';
            ...
            buffer += escapeExpression(stack1) + "&companyName=";
            if (helper = helpers.companyName) {
                stack1 = helper.call(depth0, {
                    hash: {},
                    data: data
        ...
        function program9(depth0, data) {
            var buffer = "",
                stack1, helper;
            buffer += ' <a class="detailBtn underLine" href="/company/inforService.htm?companyId=';
            if (helper = helpers.companyId) {
                stack1 = helper.call(depth0, {
                    hash: {},
                    data: data
        ...
        buffer += '<a style="float:right;margin:0 26px 20px 0;height:40px;width:100px;border:1px solid #ccc;text-align:center;line-height:40px;"\r\n    id="deleveval">excel导出</a>\r\n<table class="table table-border table-bordered table-hover">\r\n    <thead class="text-c">\r\n        <tr>\r\n            <th>店铺</th>\r\n            <th>查询时间</th>\r\n            <th>身份核验次数</th>\r\n            <th>EID报告次数</th>\r\n            <th>总金额</th>\r\n        </tr>\r\n        ';
