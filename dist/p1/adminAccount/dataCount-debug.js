define("xg/eid-company/1.0.4/p/adminAccount/dataCount-debug", ["jquery/jquery/1.10.1/jquery-debug", "xg/eid-company/1.0.4/c/js/tools-debug", "xg/eid-company/1.0.4/c/js/bootstrap-debug", "xg/eid-company/1.0.4/c/js/jquery-debug.validate", "xg/eid-company/1.0.4/c/js/validate-add-methods-debug", "xg/eid-company/1.0.4/c/js/validate-messages-cn-debug", "xg/eid-company/1.0.4/c/js/moment-debug", "xg/eid-company/1.0.4/c/handlebars/headerTmp-debug.handlebars", "xg/eid-company/1.0.4/c/handlebars/modifyPassword-debug.handlebars", "xg/eid-company/1.0.4/c/handlebars/modifyInfo-debug.handlebars", "xg/eid-company/1.0.4/c/handlebars/showCheckInfo-debug.handlebars", "xg/eid-company/1.0.4/c/handlebars/versionH-debug.handlebars", "xg/eid-company/1.0.4/c/js/jquery-debug.pager", "xg/eid-company/1.0.4/c/js/registerHelper-debug", "alinw/handlebars/1.3.0/runtime-debug", "xg/eid-company/1.0.4/c/static/h-ui/js/H-ui-debug", "xg/eid-company/1.0.4/c/css/bootstrap-debug.css", "xg/eid-company/1.0.4/c/css/bootstrap-datetimepicker-debug.css", "xg/eid-company/1.0.4/c/js/bootstrap-datetimepicker-debug", "xg/eid-company/1.0.4/c/js/bootstrap-datetimepicker-debug.zh-CN", "xg/eid-company/1.0.4/p/adminAccount/dataCountH/dataCountMH-debug.handlebars", "xg/eid-company/1.0.4/p/adminAccount/dataCountH/dataCountTableH-debug.handlebars", "xg/eid-company/1.0.4/p/adminAccount/dataCountH/picter-debug.handlebars"], function(require, exports, module) {
    ...
    require("xg/eid-company/1.0.4/c/css/bootstrap-debug.css");
    require("xg/eid-company/1.0.4/c/css/bootstrap-datetimepicker-debug.css");
    ...
    var queryDateType = 1;
    var queryval = "";
    var dataCountMH = require("xg/eid-company/1.0.4/p/adminAccount/dataCountH/dataCountMH-debug.handlebars");
    var dataCountTableH = require("xg/eid-company/1.0.4/p/adminAccount/dataCountH/dataCountTableH-debug.handlebars");
    var picter = require("xg/eid-company/1.0.4/p/adminAccount/dataCountH/picter-debug.handlebars");
    var dd = new Date;
    var seperator1 = "-";
    ...
    var m1 = bb.getMonth() + 1 < 10 ? "0" + (bb.getMonth() + 1) : bb.getMonth() + 1;
    var d1 = bb.getDate() < 10 ? "0" + bb.getDate() : bb.getDate();
    ...
    var dataCount = {
        ...
        setDatetimepicker: function() {
            ...
            $("body").find(".starmonth_time").on("change", function(e) {
                ...
                data.start = starttime, data.source = queryval, data.queryDateType = queryDateType, data.end = endtime, self.dataList(data)
            });
            ...
            $("body").find(".startTime").on("change", function(e) {
                ...
                starttime = $(".startTime").val().length > 0 ? $(".startTime").val() + " " + "" : "", endtime = $(".endTime").val().length > 0 ? $(".endTime").val() + " " + "" : "", data.pageIndex = 1;
                data.companyName = $("#companyName").val();
                data.start = starttime, data.source = queryval, data.queryDateType = queryDateType, data.end = endtime, self.dataList(data)
            });
        ...
        searchData: function() {
            ...
            var validate = $("#dataCount_searchForm").validate({
                ...
                submitHandler: function(form) {
                    data.pageIndex = 1;
                    data.companyName = $("#companyName").val();
                    data.start = starttime, data.queryDateType = queryDateType, data.end = endtime, data.source = queryval, self.dataList(data)
                }
            })
        }
    };
...
define("xg/eid-company/1.0.4/c/css/bootstrap-debug.css", [], function(require, exports, module) {
...
define("xg/eid-company/1.0.4/c/css/bootstrap-datetimepicker-debug.css", [], function(require, exports, module) {
...
define("xg/eid-company/1.0.4/p/adminAccount/dataCountH/dataCountMH-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
        ...
        var buffer = "",
            stack1, helper, functionType = "function",
            escapeExpression = this.escapeExpression;
        buffer += '<div class="queryBox text" id="statusSelect"style="margin-left:15px;" >\r\n    已累计查询';
...
define("xg/eid-company/1.0.4/p/adminAccount/dataCountH/dataCountTableH-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
...
define("xg/eid-company/1.0.4/p/adminAccount/dataCountH/picter-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    var Handlebars = require("alinw/handlebars/1.3.0/runtime-debug");
    var template = Handlebars.template;
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        this.compilerInfo = [4, ">= 1.0.0"];
