define("xg/eid-company/1.0.4/p/report/fullReport-debug.handlebars", ["alinw/handlebars/1.3.0/runtime-debug"], function(require, exports, module) {
    ...
    module.exports = template(function(Handlebars, depth0, helpers, partials, data) {
        ...
        function program2(depth0, data) {
            ...
            buffer += "\r\n        <tr>\r\n            <td>" + escapeExpression((helper = helpers.isEmpty || depth0 && depth0.isEmpty, options = {
                ...
                hash: {},
                data: data
            }, helper ? helper.call(depth0, depth0 && depth0.courtName, options) : helperMissing.call(depth0, "isEmpty", depth0 && depth0.courtName, options))) + '</td>\r\n            <td><span class="ellipsis w450">' + escapeExpression((helper = helpers.setNull || depth0 && depth0.setNull, options = {
                hash: {},
                data: data
