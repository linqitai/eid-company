define(function(require, exports, module) {
    ...
    var main = {
        ...
        //加载完整报告
        getPlScan1: function() {
            console.log("into加载完整报告");
            var self = this;
            self.getTotalReport();
            self.getRiskReport();
            console.log("before getClBehavior");
            self.getClBehavior();
            console.log("before getBadBehavior");
            self.getBadBehavior();
            console.log("before getConsumeBehavior");
            self.getConsumeBehavior();
            console.log("beforegetPlScan");
            self.getPlScan();
            console.log("before");
            self.getCommunicationTrack();
            console.log("end");
